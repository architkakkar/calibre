...
const nutritionCards: CardData[] = [
  {
    title: "Quick Start",
    icon: Rocket01Icon,
    points: [
      "Fill your nutrition preferences",
      "Generate your AI-crafted plan",
      "Follow your daily meals",
    ],
  },
  {
    ...
    icon: Target03Icon,
    points: [
      "Personalized to your nutrition needs",
      "Balanced meals with macros and calories",
        ...
        <header className="text-center space-y-3 relative z-10">
          <h2 className="text-4xl font-bold tracking-tight">
            ...
            <span className="relative inline-block pb-2">
              ...
              <svg
                aria-hidden
                className="absolute left-0 right-0 bottom-0 h-4.5 w-full text-emerald-600"
                viewBox="0 0 120 16"
          ...
          <p className="text-base text-muted-foreground max-w-4xl">
            ...
            routine tailored to your nutrition needs.
          </p>
        </header>
