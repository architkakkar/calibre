  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-background text-foreground flex">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0 h-full w-full">
        ...
        <Card className="relative hidden md:flex m-3 rounded-2xl border-border/70 overflow-hidden bg-linear-to-br from-card via-background to-background/95 shadow-2xl">
          <div
          ...
          <CardContent className="relative flex h-full flex-col justify-between p-10 gap-8">
            ...
            <div className="flex flex-col items-start gap-3 text-sm max-w-lg">
        ...
        {/* Right panel - Form Section (children) */}
